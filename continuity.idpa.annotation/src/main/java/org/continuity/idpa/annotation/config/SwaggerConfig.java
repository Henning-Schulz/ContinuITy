...
public class SwaggerConfig {
	...
	@Bean
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select().apis(RequestHandlerSelectors.basePackage("org.continuity.idpa.annotation.controllers")).build().apiInfo(apiInfo());
	}
