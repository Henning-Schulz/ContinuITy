...
public class WorkloadModelPack extends LinkExchangeModel {
	...
	public WorkloadModelPack(String hostname, String id, String tag) {
		getWorkloadModelLinks().setType(WorkloadModelType.REQUEST_RATES).setLink(hostname + RequestRates.Model.OVERVIEW.path(id)).setJmeterLink(hostname + RequestRates.JMeter.CREATE.path(id));
